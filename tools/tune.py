...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='tuning for SiamFDB')
    parser.add_argument('--dataset_root', default='./datasets', type=str, help='datasetdir')
    parser.add_argument('--dataset', default='GOT-10k', type=str, help='dataset')
    parser.add_argument('--config', default='./experiments/siamFDB_r50/config.yaml', type=str, help='config file')
